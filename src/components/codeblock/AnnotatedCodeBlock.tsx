    ...
    >
      ...
      {title && (
        ...
        >
          ...
          <span
            className="text-[10px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded ml-auto"
          ...
          >
            ...
            <div className="flex-1 px-4 py-2 min-w-0">
              <div className="flex items-start gap-3">
                <span className="text-[10px] font-mono w-5 text-right shrink-0 pt-0.5" style={{ color: "var(--text-tertiary)", opacity: 0.5 }}>
                  {i + 1}
                </span>
                <pre className="text-[13px] font-mono whitespace-pre-wrap break-all" style={{ color: "var(--text-primary)" }}>
                  {line.code}
                </pre>
              </div>
            </div>
            ...
            {line.annotation && (
              <div
                className="sm:w-[260px] shrink-0 px-4 py-2 flex items-start gap-2 border-t sm:border-t-0 sm:border-l"
                style={{
                  borderColor: "var(--border-secondary)",
                  background: `${line.color || accent}05`,
                }}
              >
                <span className="text-xs mt-0.5" style={{ color: line.color || accent }}>←</span>
